      ...
      colors: [
        {
          id: 1,
          name: 'черный',
          images: ['/assets/images/1/black_front.png', '/assets/images/1/black_back.png'],
          price: '123.00',
        ...
        },
        {
          id: 2,
          name: 'белый',
          images: ['/assets/images/1/white_front.png', '/assets/images/1/white_back.png'],
          price: '125.00',
        ...
        },
        {
          id: 3,
          name: 'серый',
          images: ['/assets/images/1/gray_front.png', '/assets/images/1/gray_back.png'],
          price: '120.00',
      ...
      colors: [
        {
          id: 1,
          name: 'желтый',
          images: ['/assets/images/2/yellow_front.png', '/assets/images/2/yellow_back.png'],
          price: '88.00',
        ...
        },
        {
          id: 2,
          name: 'синий',
          images: ['/assets/images/2/blue_front.png', '/assets/images/2/blue_back.png'],
          price: '89.00',
        ...
        },
        {
          id: 3,
          name: 'черный',
          images: ['/assets/images/2/black_front.png', '/assets/images/2/black_back.png'],
          price: '90.00',
